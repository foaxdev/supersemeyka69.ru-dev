        ...
        <div class="header__menu-wrap">
            <nav class="main-nav">
                <ul class="header__list nav-list">
                    <li class="nav-list__item"><a class="nav-list__link" href="#features">О нас</a></li>
                    <li class="nav-list__item"><a class="nav-list__link" href="#faculties">Направления</a></li>
                    <li class="nav-list__item"><a class="nav-list__link" href="#schedule">Расписание</a></li>
                    <li class="nav-list__item"><a class="nav-list__link" href="#teachers">Преподаватели</a></li>
                    <li class="nav-list__item"><a class="nav-list__link nav-list__link--news" href="#news">Новости</a></li>
                    <li class="nav-list__item"><a class="nav-list__link nav-list__link--photo" href="#photo-gallery">Фото</a></li>
                    <li class="nav-list__item"><a class="nav-list__link nav-list__link--video" href="#video">Видео</a></li>
